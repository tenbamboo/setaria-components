...
<p align="center">
  <a href="https://www.npmjs.org/package/setaria-components">
    <img src="https://img.shields.io/npm/v/setaria-components.svg" />
  </a>
  <a href="https://github.com/setaria-components/setaria-components">
    <img src="https://img.shields.io/badge/node-%20%3E%3D%2016-47c219" />
  </a>
  <a href="https://npmcharts.com/compare/setaria-components?minimal=true">
    <img src="https://img.shields.io/npm/dm/setaria-components.svg" />
  </a>
  <a href="https://codecov.io/gh/setaria-components/setaria-components">
    <img src="https://codecov.io/gh/setaria-components/setaria-components/branch/dev/graph/badge.svg?token=BKSBO2GLZI"/>
  </a>
  <br>
</p>
...
For developers that uses Element Plus to develop your website you should go ahead visit [Getting Started](https://setaria-components.org/).

- 中国大陆[加速镜像站点](https://setaria-components.gitee.io/)
...
You can find the breaking change list here: [Breaking Change List](https://github.com/setaria-components/setaria-components/discussions/5658).
...
[Playground](https://setaria-components.run/)

#### Try it with code sandbox

[![Edit setaria-components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/setaria-components-demo-dxtcr)
...
<table align="center" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      ...
      <td align="center" valign="middle">
        <a href="https://js.design?source=setaria-components" target="_blank">
          <img width="150px" src="https://user-images.githubusercontent.com/17680888/160634485-df0d00af-8633-4ab8-9a72-aac2b65d1d36.png">
        </a>
      </td>
      <td align="center" valign="middle">
        <a href="https://www.misboot.com/?from=setaria-components" target="_blank">
...
<table align="center" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      <td align="center" valign="middle">
        <a href="https://wonderful-code.gitee.io/?from=setaria-components" target="_blank">
...
a proofreader [![Crowdin](https://badges.crowdin.net/setaria-components/localized.svg)](https://crowdin.com/project/setaria-components)
...
See how to help translating in [Translating Element Plus](https://setaria-components.org/en-US/guide/translation.html).
...
[CONTRIBUTING](https://github.com/setaria-components/setaria-components/blob/dev/CONTRIBUTING.md) and
[Code of Conduct](https://github.com/setaria-components/setaria-components/blob/dev/CODE_OF_CONDUCT.md)
...
<a href="https://github.com/setaria-components/setaria-components/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=setaria-components/setaria-components" />
</a>

## License

Element Plus is open source software licensed as
[MIT](https://github.com/setaria-components/setaria-components/blob/master/LICENSE).
