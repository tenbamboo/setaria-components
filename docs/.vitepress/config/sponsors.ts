export const rightRichTextSponsors = [
  {
    ...
    url: 'https://www.misboot.com/?from=setaria-components',
...
export const rightLogoSmallSponsors = [
  {
    ...
    url: 'https://wonderful-code.gitee.io/?from=setaria-components',
...
export const leftCustomImgSponsors = [
  {
    ...
    url: 'https://js.design/?source=setaria-components&plan=sy',
