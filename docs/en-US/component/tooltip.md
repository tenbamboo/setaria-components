...
In fact, Tooltip is an extension based on [ElPopper](https://github.com/setaria-components/setaria-components/tree/dev/packages/components/popper), you can use any attribute that are allowed in ElPopper.
