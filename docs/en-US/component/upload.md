...
| http-request                  | override default xhr behavior, allowing you to implement your own upload-file's request.                                                                                              | ^[Function]`(options: UploadRequestOptions) => XMLHttpRequest \| Promise<unknown>`                                                           | ajaxUpload [see](https://github.com/setaria-components/setaria-components/blob/dev/packages/components/upload/src/ajax.ts#L55) |
