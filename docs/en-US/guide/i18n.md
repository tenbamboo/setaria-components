...
```html
<script src="//unpkg.com/setaria-components/dist/locale/zh-cn"></script>
<script>
  app.use(ElementPlus, {
...
[Supported Language List](https://github.com/setaria-components/setaria-components/tree/dev/packages/locale/lang)
...
If you need any other languages, [PR](https://github.com/setaria-components/setaria-components/pulls)
is always welcomed, you only need to add a language file at
[here](https://github.com/setaria-components/setaria-components/tree/dev/packages/locale/lang).
