...
- Full import: [setaria-components-vite-starter](https://github.com/setaria-components/setaria-components-vite-starter)
- On demand: [unplugin-setaria-components/examples/vite](https://github.com/setaria-components/unplugin-setaria-components)

### By SCSS variables

`theme-chalk` is written in SCSS.
You can find SCSS variables in [`packages/theme-chalk/src/common/var.scss`](https://github.com/setaria-components/setaria-components/blob/dev/packages/theme-chalk/src/common/var.scss).
...
In the future, we will write documentation for variables that can be customized for each component. You can also directly checkout the source [var.scss](https://github.com/setaria-components/setaria-components/blob/dev/packages/theme-chalk/src/common/var.scss).
...
Import `element/index.scss` before scss of setaria-components to avoid the problem of sass mixed variables, because we need generate light-x by your custom variables.

:::

Create a `element/index.scss` to combine your variables and variables of setaria-components. (If you import them in ts, they will not be combined.)

:::tip

In addition, you should distinguish your scss from the element variable scss.
If they are mixed together, each hot update of `setaria-components` needs to compile a large number of scss files, resulting in slow speed.
...
// or use unplugin-setaria-components
...
```ts
// webpack.config.ts
// use unplugin-setaria-components
