...
[支持的语言列表](https://github.com/setaria-components/setaria-components/tree/dev/packages/locale/lang)
...
如果你需要使用其他的语言，欢迎贡献 [PR](https://github.com/setaria-components/setaria-components/pulls)，只需在[这里](https://github.com/setaria-components/setaria-components/tree/dev/packages/locale/lang)添加一个语言配置文件即可。
